  ...
  private apiSpec: ApiSpec = {
    ...
    groups: [
      ...
      },
      {
        name: 'SLA Policies',
        endpoints: [
            { method: 'POST', path: '/slapolicies', description: 'Cria uma nova política de SLA.', needsAuth: true, pathParams: [], requestBodyExample: JSON.stringify({"name":"SLA Padrão - TI","responseTimeMinutes":120,"resolutionTimeMinutes":480,"operationalHoursOnly":true,"isActive":true,"tenantId":1,"categoryDto":{"name":"Infraestrutura","description":"Problemas de infraestrutura"},"priorityDto":{"name":"Alta"}}, null, 2) },
